...
const SearchBarHeader = () => {
    ...
    return (
        <>
            <div id='search-bar-header' className='w-full h-[52px] lg:h-24 flex items-center justify-between'>
                <button className='h-[52px] w-[52px] lg:w-24 lg:h-24 text-red-600 border border-black focus:outline-none' onClick={handleToggleMenu}>
                ...
                <button className='h-[52px] w-[52px] lg:w-24 lg:h-24 text-red-600 border border-black focus:outline-none' onClick={handleToggleSearch}>
